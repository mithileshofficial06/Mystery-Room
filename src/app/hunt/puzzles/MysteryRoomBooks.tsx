...
/**
 * The one that matters: back bay, lower shelf, middle slot.
 *
 * The back bay is the darkest end of the run — furthest from the pendant lamps
 * and half in the shadow of the step ladder — which is where a person hiding
 * something in a library would put it.
 */
const TARGET_ID = "b0-0-1";
